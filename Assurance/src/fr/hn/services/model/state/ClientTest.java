...
public class ClientTest {
	...
	public static void main(final String[] args) throws IOException {
		...
		ArretMaladieContext context = new ArretMaladieContext();

		State etatFeuilledesoin = new EtatFeuilleDeSoin();
		context.setEtat(etatFeuilledesoin);

		context.doAction(feuilleDeSoin);
